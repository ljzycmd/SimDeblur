"""
This code mainly come from the official repo, if you want to learn about more details, 
please visit https://github.com/zzh-tech/ESTRNN
"""
...
class GSA(nn.Module):
    def __init__(self, n_features, past_frames, future_frames, activation="relu"):
        super(GSA, self).__init__()
        self.n_feats = n_features
        self.center = past_frames
...
class Reconstructor(nn.Module):
    def __init__(self, n_features, future_frames, past_frames):
...
class ESTRNN(nn.Module):
    ...
    """
    def __init__(self, n_features=16, n_blocks=15, future_frames=2, past_frames=2, activation="gelu"):
        super(ESTRNN, self).__init__()
        self.n_feats = n_features
        self.num_ff = future_frames
        self.num_fb = past_frames
        self.ds_ratio = 4
        self.cell = RDBCell(activation, n_features, n_blocks)
        self.recons = Reconstructor(n_features, future_frames, past_frames)
        self.fusion = GSA(n_features, past_frames, future_frames, activation)
